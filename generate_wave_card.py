...
try:
    ...
    text = soup.get_text("\n")
    print("Forecast page fetched and parsed")
    ...
    if m:
        ...
        if final_lines:
            forecast_text = "\n".join(final_lines)
            print("Forecast text parsed successfully:", forecast_text[:200])
except Exception as e:
    print("Error in PART 1 forecast parsing:", str(e))
...
try:
    ...
    print("Buoy page fetched and parsed")
        ...
        if len(rows) >= 2:
            ...
            if len(cols) >= 5:
                ...
                if swd and swd not in ["MM", "-"]:
                    buoy_dir = swd
                print("Buoy data parsed:", sig_height, swell_height, swell_period, buoy_dir)
except Exception as e:
    print("Error in PART 2 buoy parsing:", str(e))
...
try:
    ...
    print("Error fetching background:", str(e))
...
try:
    ...
    print("Error fetching logo:", str(e))
...
try:
    ...
    print("Error loading fonts:", str(e))
...
print("Drawing complete, attempting to save card")
